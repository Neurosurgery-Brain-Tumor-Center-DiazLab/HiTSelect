function varargout = choose_file_type(varargin)
...
% Last Modified by GUIDE v2.5 12-May-2014 16:08:59

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @choose_file_type_OpeningFcn, ...
                   'gui_OutputFcn',  @choose_file_type_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function choose_file_type_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = choose_file_type_OutputFcn(hObject, eventdata, handles)
...
handles.output.sample_type = contents{get(hObject,'Value')};
...
set(hObject,'String',{'Select data type...','Screen data','Gene expression data'})
...
contents = cellstr(get(hObject,'String'));
handles.output.build = contents{get(hObject,'Value')};
...
set(hObject,'String',{'Select organism...','hg19','mm9'})
...
if isempty(n), alert('String','Please enter a valid number...'), return; end
handles.output.num_treat=n;
guidata(hObject, handles);
