function [M1, M2, rnk, mlodz, nsh, ntar, ndes] = pareto_rank(pos_cnt,neg_cnt,n,uniq_locs)
%function [M1 M2 rnk mlodz nsh ntar ndes] =pareto_rank(pos_cnt,neg_cnt,n,uniq_locs)
%
...
for i=1:n %for each gene compute the numbers of infected, sequenced, and active hairpins and the cumulative hairpin activity level
...
for i=1:n %for all genes compute all pairwise domination probabilities in both metrics 
    tmp1=zeros(1,n);
    tmp2=zeros(1,n);
    for j=1:i-1
